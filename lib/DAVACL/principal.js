 ...
 */
var jsDAV_Principal = module.exports = jsDAV_Node.extend(jsDAVACL_iPrincipal, jsDAV_iProperties, jsDAVACL_iAcl, {
    /**
    ...
    initialize: function(principalBackend, principalProperties) {
        if (!principalProperties.uri)
            throw new Exc.Exception("The principal properties must at least contain the \"uri\" key");
    ...
    getAlternateUriSet: function() {
        ...
        if (this.principalProperties["{http://sabredav.org/ns}email-address"])
            uris.push("mailto:" + this.principalProperties["{http://sabredav.org/ns}email-address"]);
    ...
    getGroupMemberSet: function(callback) {
        return this.principalBackend.getGroupMemberSet(this.principalProperties.uri, callback);
    },
    ...
    getGroupMembership: function(callback) {
        return this.principalBackend.getGroupMemberShip(this.principalProperties.uri, callback);
    },
