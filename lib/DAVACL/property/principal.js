    ...
    this.unserialize = function(dom) {
        ...
        switch(Util.toClarkNotation(parentNode)) {
            case '{DAV:}unauthenticated' :
                return new jsDAV_Property_Principal(this.UNAUTHENTICATED);
            case '{DAV:}authenticated' :
                return new jsDAV_Property_Principal(this.AUTHENTICATED);
            case '{DAV:}href':
                return new jsDAV_Property_Principal(this.HREF, parentNode.textContent);
            case '{DAV:}all':
                return new jsDAV_Property_Principal(this.ALL);
            default:
