...
module.exports = Base.extend({
    ...
    validate: function (vObject, filter) {
        ...
        return this._validateFilterSet(
                   vObject, filter["comp-filters"], this._validateCompFilter) &&
               this._validateFilterSet(
                   vObject, filter["prop-filters"], this._validatePropFilter);
    ...
    _validateCompFilter: mkCommonValidator(function(children, filter) {
        ...
        return childrenMatchesRange.some(function(child) {
            return this._validateFilterSet(
                       child, filter["comp-filters"], this._validateCompFilter) &&
                   this._validateFilterSet(
                       child, filter["prop-filters"], this._validatePropFilter);
        }, this);
    }),
    ...
    _validatePropFilter: mkCommonValidator(function(children, filter) {
        return this._anyChildMatches(children, filter, function(child, filter) {
            ...
            return this._validateFilterSet(
                child, filter["param-filters"], this._validateParamFilter);
        });
    ...
    _validateTimeRange: function (component, filter) {
        ...
        switch (component.name) {
            ...
            case "VALARM" :
                ...
                */
            case "VFREEBUSY" :
                 throw new Exc.NotImplemented("time-range filters are currently not supported " +
                                              "on " + component.name + " components");
            case "COMPLETED" :
            case "CREATED" :
            case "DTEND" :
            case "DTSTAMP" :
            ...
            default :
                // throw new Exc.BadRequest("You cannot create a time-range filter on a " +
