 ...
 */
module.exports = jsDAVACL_AbstractPrincipalCollection.extend({
    /**
     * Principal Backend
     *
    ...
    initialize: function(principalBackend, caldavBackend, principalPrefix) {
        ...
        jsDAVACL_AbstractPrincipalCollection.initialize.call(
            this, principalBackend, principalPrefix ||  "principals");
    },
