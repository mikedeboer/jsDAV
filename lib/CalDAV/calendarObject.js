...
var jsDAV_CalDAV_Property_SupportedCalendarComponentSet = require('./property/supportedCalendarComponentSet');
...
(function() {
    ...
    this.getETag = function(callback) {
        ...
        this.get(function(err, data) {
            ...
            self.objectData.etag = '"'+hash.digest('hex')+'"';
            callback(null, self.objectData.etag);
        });
    }
