...
var jsCalDAV_Plugin = module.exports = jsDAV_Plugin.extend({
    ...
    calendarQueryReport: function(e, dom) {
         ...
         console.log('Plugin::calendarQueryReport');
         ...
         try {
             ...
             console.log('Plugin::calendarQueryReport ERROR', ex, ex.stack);
             return e.next(ex);
         }
         ...
         function afterCandidates(candidateNodes) {
             ...
             console.log('Plugin::calendarQueryReport afterCandidates', candidateNodes);
