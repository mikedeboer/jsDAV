...
function jsDAV_CalDAV_Plugin(handler) {
    ...
    this.handler.protectedProperties = this.handler.protectedProperties.concat([
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}supported-calendar-component-set',
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}supported-calendar-data',
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}max-resource-size',
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}min-date-time',
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}max-date-time',
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}max-instances',
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}max-attendees-per-instance',
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}calendar-home-set',
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}supported-collation-set',
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}calendar-data',

        // scheduling extension
        '{'+jsDAV_CalDAV_Plugin.NS_CALDAV+'}calendar-user-address-set',

        // CalendarServer extensions
        '{'+jsDAV_CalDAV_Plugin.NS_CALENDARSERVER+'}getctag',
        '{'+jsDAV_CalDAV_Plugin.NS_CALENDARSERVER+'}calendar-proxy-read-for',
        '{'+jsDAV_CalDAV_Plugin.NS_CALENDARSERVER+'}calendar-proxy-write-for'
    ]);
}
