...
var jsCalDAV_Plugin = module.exports = jsDAV_Plugin.extend({
    ...
    calendarQueryReport: function(e, dom) {
         ...
         var
             query = jsCalDAV_CalendarQueryParser.new(dom),
             validator = jsCalDAV_CalendarQueryValidator.new(),
             self = this,
             depth = this.handler.getHTTPDepth(0);
         ...
         function afterCandidates(candidateNodes) {
             ...
             .end(function(err) {
                 ...
                 .end(function(err) {
                     ...
                     prefer = self.handler.getHTTPPrefer();
