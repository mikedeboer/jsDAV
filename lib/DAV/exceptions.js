...
exports.jsDAV_Exception = function(msg, extra) {
     ...
     * @return array
     */
    this.getHTTPHeaders = function(server) {return {}; };
    ...
    this.toString = function(server) {
        var headers = "";
        if (server) {
            headers = "Headers: ";
            var h = this.getHTTPHeaders(server);
            for (var i in h) {
                headers += "\t" + i + ": " + h[i] + "\n";
            }
        }
        return headers + "HTTP code: " + this.code + "\n"
            + "Exception type: " + this.type + "\n"
...
exports.jsDAV_Exception_MethodNotAllowed = function(msg, extra) {
    ...
    this.getHTTPHeaders = function(server) {
        var methods = server.getAllowedMethods(server.getRequestUri());
        return {
