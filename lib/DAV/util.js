...
var Element = exports.Element = function(parent, prefix, uri, tagName) {
...
(function() {
    ...
    this.dispatchEvent = function(eventName, e) {
        ...
        e = !e || !e.$event ? new exports.Event(Array.prototype.slice.call(arguments)) : e;

        for (var listener, i = 0, l = listeners && listeners.length ? listeners.length : 0; i < l; ++i) {
            listener = listeners[i];
            listener.apply(null, [e].concat(e.args || []));
...
exports.Event = function() {
    ...
    if (args.length === 0) {
        if (t == "string") {
            ...
            this.type = first.shift();
            this.args = first;
        }
        else if (t == "object") {
            this.args = [];
            exports.extend(this, args[0]);
        }
    }
    else {
        this.type = first;
    ...
    if (typeof this.callback != "function" && this.args.length
      && typeof this.args[this.args.length - 1] == "function")
        this.callback = this.args.pop();

    this.next = function(err) {
        if (this.$done || !this.callback)
            return (!this.callback ? this.$done = true : false);
        this.$done = true;
        this.callback.apply(this, [err].concat(this.args || []));
    };
