...
function jsDAV_iCollection() {
     ...
     * @return void
     */
    this.createFile = this.createFile || function(name, data, type, callback) {
     ...
     * @return void
     */
    this.createDirectory = this.createDirectory || function(name, callback) {
     ...
     * @return jsDAV_INode
     */
    this.getChild = this.getChild || function(name, callback) {
        callback(new Exc.jsDAV_Exception("iCollection.getChild() is not implemented!"));
    }
     ...
     * @return jsDAV_INode[]
     */
    this.getChildren = this.getChildren || function(callback) {
        callback(new Exc.jsDAV_Exception("iCollection.getChildren() is not implemented!"));
    }
}
