...
(function() {
    ...
    this.validate = function(handler, cbvalidate) {
        ...
        function afterBody() {
            ...
            validResponse = Util.md5(_self.A1 + ":" + _self.digestParts["nonce"] + ":" 
                + _self.digestParts["nc"] + ":" + _self.digestParts["cnonce"] + ":" 
                + _self.digestParts["qop"] + ":" + A2); 
    
            cbvalidate(_self.digestParts["response"] == validResponse);
        }
