...
//        }
    ...
    this.parseSearchResult = function(res, basePath, options) {
        var prevFile, parts, file, lineno, result = "";
        ...
        for (; i < l; ++i) {
            ...
            result += "\n\t" + lineno + ": " + Util.escapeXml(truncate(parts.shift(), options));
        }
        ...
        return Util.escapeXml(options.query) + ":" + Util.escapeXml(options.replacement) + ":" + optionsDesc + "\n" + count + ":" + filecount + "\n" + result;
    };
