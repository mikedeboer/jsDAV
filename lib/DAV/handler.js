...
(function() {
    ...
    this.invoke = function() {
        ...
        if (jsDAV.debugMode) {
            ...
            console.log("REQUEST START:", method, this.httpRequest.url, this.id);
            ...
            this.httpResponse.end = function(content) {
                console.log("INFO: request end: ", self.id);
        ...
        self.dispatchEvent("beforeGetProperties", path, node, propertyNames, newProperties, function(stop) {
            ...
            Async.list(propertyNames)
                 ...
                 .each(function(prop, cbnextprops) {
                     ...
                     if (prop == "{DAV:}getlastmodified") {
                         ...
                         for(var pluginName in self.plugins)
                             reports.push.apply(reports, self.plugins[pluginName].getSupportedReportSet(path));
                 ...
                 .end(function(err) {
                     ...
                     path = Util.trim(path, "/");
                     self.dispatchEvent("afterGetProperties", path, newProperties, function() {
