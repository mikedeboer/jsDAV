                         ...
                         Async.list(propertyNames)
                              ...
                              .each(function(prop, cbnextprops) {
                                  ...
                                  if (prop == "{DAV:}getlastmodified") {
                                      ...
                                      newProperties["404"][prop] = '';
                                      cbnextprops();
                                  }
                              })
                              .end(function(err) {
                                  myPath = Util.trim(myPath, "/");
                                  self.dispatchEvent("afterGetProperties", myPath, newProperties, function() {
                                      if (parentNode.hasFeature(jsDAV.__ICOLLECTION__)) {
                                          ...
                                          if (s.charAt(0) != ".") {
                                              myPath = s.indexOf(self.server.baseUri) !== 0
                                                  ? myPath.replace(new RegExp("^"+Util.escapeRegExp(s)), "").replace(/^[\/]+/, "")
                                                  : myPath;
                                          }
                                      }
