...
function jsDAV_iFile() {
     ...
     * @return void
     */
    this.put = this.put || function(data, type, callback) {
     ...
     * @return mixed
     */
    this.get = this.get || function(callback) {
        callback();
    };
     ...
     * @return void
     */
    this.getContentType = this.getContentType || function(callback) {
        callback(null, null);
    };
     ...
     * @return void
     */
    this.getETag = this.getETag || function(callback) {
        callback(null, null);
    };
     ...
     * @return int
     */
    this.getSize = this.getSize || function(callback) {
        this.get(function(err, body) {
            if(err) return callback(err);
            callback(null, body ? Buffer.byteLength(body) : 0);
        });
    };
}
